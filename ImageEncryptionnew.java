...
public class ImageEncryption {
    ...
    public static void main(String[] args) throws IOException {
        ...
        double pixelExpansionFactor = 2000;

        // Encrypt the image using simulated annealing
        BufferedImage[] encryptedShares = encryptImage(originalImage, numShares, pixelExpansionFactor);

        // Save the encrypted shares
        for (int i = 0; i < numShares; i++) {
            ImageIO.write(encryptedShares[i], "jpeg", new File("SA_encryptedShare" + i + ".jpeg"));
        }
        ...
        ImageIO.write(decryptedImage, "jpeg", new File("SA_decryptedImage.jpeg"));
    }
